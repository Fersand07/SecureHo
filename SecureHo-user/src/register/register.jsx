    ...
    <section id="Signup">
        <div class="datos">
            ...
            <div id="icocontainer">
                ...
                <img class="iconos" src="/img/mail_FILL0_wght400_GRAD0_opsz48.png" alt="sobre"/>
                <img class="iconos" src="/img/baseline_lock_black_24dp.png" alt="candado"/>
                <img class="iconos" src="/img/baseline_lock_black_24dp.png" alt="candado"/>
                <img class="iconos" src="/img/baseline_key_black_24dp.png" alt="key"/>
            </div>
            <button class="btnorigin">
              Register
          </button>
        </div>
        <img class="imgsignup" src="/img/sign up.jpg" alt="img"/>
